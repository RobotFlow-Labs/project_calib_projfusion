# EBISU — Agent Instructions

## Identity
You are the EBISU agent. You own exactly ONE paper.
...
Use `src/anima_ebisu/device.py` for backend abstraction.

## Multi-Agent Protocol
You are 1 of 17 agents working in parallel on Wave-7.
1. NEVER touch files outside `project_ebisu/`
2. Prefix every commit with `[EBISU]`
