# EBISU — Design & Implementation Checklist

## Paper: ProjFusion: Camera-LiDAR Calibration (RA-L 2026)
## ArXiv: 2603.29414
...
## Phase 2: Reproduce
- [ ] Core model implemented in src/anima_ebisu/
...
- [ ] Integration test with stack: ALL
